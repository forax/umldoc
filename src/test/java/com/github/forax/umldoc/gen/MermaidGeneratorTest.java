...
public class MermaidGeneratorTest {
   ...
   */
  @Test
  public void generateSequenceDiagramMethodsMermaid() throws IOException {
    var descriptor = Type.getMethodDescriptor(Type.getType(void.class));
    var voidType = TypeInfo.of("void");
    var publicModifier = Set.of(Modifier.PUBLIC);
   ...
   */
  @Test
  public void generateSequenceDiagramMethodsMermaidWith3Entities() throws IOException {
    var descriptor = Type.getMethodDescriptor(Type.getType(void.class));
    var voidType = TypeInfo.of("void");
    var publicModifier = Set.of(Modifier.PUBLIC);
 ...
 */
  @Test
  public void generateSequenceDiagramMethodsMermaidWith3EntitiesAndDifferentGroups() throws IOException {
    var descriptor = Type.getMethodDescriptor(Type.getType(void.class));
    var voidType = TypeInfo.of("void");
    var publicModifier = Set.of(Modifier.PUBLIC);
